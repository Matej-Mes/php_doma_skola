...
?>
    ...
    <a href="DUTabulka.php?jazyk=sk">SK</a>
    <a href="DUTabulka.php?jazyk=en">EN</a>
...
{
    echo "<a href=DUTabulka.php?trieda=".$row1["trieda"]."&amp;skupina=".$row1["skupina"].">".$row1["trieda"]." - ".$row1["skupina"].".sk</a></br>";
}
